...
### Added
- `desktop-linux.md` - Claude Desktop on Linux (beta)
...
- `amazon-bedrock.md`
  - Content updated
- `auto-mode-config.md`
  - New section: "Route all shell commands through the classifier"
- `changelog.md`
  - Content updated
...
- `monitoring-usage.md`
  - Content updated
- `permission-modes.md`
  - Removed section: "Eliminate prompts with auto mode"
- `sandboxing.md`
  - Content updated
- `server-managed-settings.md`
  - Content updated
...
- `migration-guide.md`
  - Content updated
- `observability.md`
  - New section: "Attribute actions to your end users"
- `permissions.md`
  - Content updated
- `python.md`
  - Content updated
...
### Added
- `admin-setup.md` - Set up Claude Code for your organization
...
### Added
- `routines.md` - Automate work with routines
...
- `desktop-scheduled-tasks.md`
  - Content updated
- `desktop.md`
  - New section: "Arrange your workspace"
- `discover-plugins.md`
  - Content updated
- `env-vars.md`
  - Content updated
...
### Added
- `2026-w15.md` - Week 15 · April 6–10, 2026
...
- `scheduled-tasks.md`
  ...
  - Removed section: "Schedule a recurring prompt with /loop"
- `server-managed-settings.md`
  - Content updated
- `settings.md`
  - Content updated
...
- `amazon-bedrock.md`
  ...
  - Removed section: "Set up with the interactive wizard"
  - Removed section: "Setup"
- `analytics.md`
  - Content updated
- `authentication.md`
  - Content updated
...
- `computer-use.md`
  - Content updated
- `context-window.md`
  - New section: "What survives compaction"
- `costs.md`
  - Content updated
- `data-usage.md`
  - Content updated
...
- `google-vertex-ai.md`
  ...
  - New section: "Set up manually"
  - New section: "Startup model checks"
  - Removed section: "Region Configuration"
  - Removed section: "Setup"
- `headless.md`
  - Content updated
- `hooks-guide.md`
...
- `interactive-mode.md`
  - New section: "Commands"
  - Removed section: "Built-in commands"
- `jetbrains.md`
  - Content updated
- `keybindings.md`
  - Content updated
...
- `analytics.md`
  - New section: "Access analytics for Team and Enterprise"
  - Removed section: "Access analytics for Teams and Enterprise"
- `best-practices.md`
  - Content updated
- `changelog.md`
  - Content updated
...
- `platforms.md`
  - Content updated
- `plugin-marketplaces.md`
  - New section: "Manage marketplaces from the CLI"
- `plugins-reference.md`
  - Content updated
- `plugins.md`
  - Content updated
...
- `channels-reference.md`
  - Content updated
- `channels.md`
  - New section: "How channels compare"
- `cli-reference.md`
  - Content updated
- `desktop.md`
  - Content updated
