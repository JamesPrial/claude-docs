...
- `claude-code-on-the-web.md`
  - Content updated
- `claude-directory.md`
  - New section: "Frontmatter fields by file"
...
- `network-config.md`
  - Content updated
- `output-styles.md`
  - New section: "Choose between an output style and other features"
  - Removed section: "Comparisons to related features"
- `overview.md`
  - Content updated
...
- `ultrareview.md`
  - Content updated
- `voice-dictation.md`
  - New section: "Cancel a recording"
- `vs-code.md`
  - Content updated
...
- `how-claude-code-works.md`
  - Content updated
- `interactive-mode.md`
  - New section: "Invisible characters in prompts"
- `keybindings.md`
  - Content updated
- `large-codebases.md`
  - Content updated
...
### Added
- `claude-projects.md` - Let Claude coordinate ongoing work with Projects
...
### Added
- `configuration.md` - Configure your agent
...
- `claude-apps-gateway.md`
  - Content updated
- `claude-code-on-the-web.md`
  - New section: "Move tasks between terminal and cloud"
  - Removed section: "Move tasks between web and terminal"
- `claude-directory.md`
  - Content updated
- `claude-platform-on-aws.md`
  - Content updated
...
- `prompt-caching.md`
  - Content updated
- `remote-control.md`
  - New section: "Remote Control vs cloud sessions"
  - Removed section: "Remote Control vs Claude Code on the web"
- `routines.md`
  - Content updated
- `sandbox-environments.md`
  - New section: "Cloud sessions"
  - Removed section: "Claude Code on the web"
- `sandboxing.md`
  - Content updated
- `scheduled-tasks.md`
  - Content updated
...
### Added
- `plugin-evals.md` - Test plugins with evals
...
- `amazon-bedrock.md`
  - Content updated
- `artifacts.md`
  - New section: "Read an artifact shared with you"
  - New section: "Offer a file download"
- `authentication.md`
  - Content updated
- `auto-mode-config.md`
  - Content updated
...
- `hooks.md`
  - Content updated
- `interactive-mode.md`
  - New section: "Issue reference links"
- `keybindings.md`
  - Content updated
- `large-codebases.md`
  - Content updated
...
- `llm-gateway-rollout.md`
  - Content updated
- `managed-mcp.md`
  - New section: "Provide servers through managed settings"
- `managed-settings.md`
  - Content updated
- `mcp.md`
  - Content updated
...
- `file-checkpointing.md`
  - Content updated
- `hosting.md`
  - New section: "Troubleshoot deployment failures"
- `mcp.md`
  - Content updated
- `migration-guide.md`
  - Content updated
...
- `overview.md`
  - Content updated
- `python.md`
  - New section: "Build a continuous conversation interface"
  - New section: "Error handling"
  - Removed section: "Advanced Features with ClaudeSDKClient"
  - Removed section: "Example Usage"
- `quickstart.md`
  - Content updated
...
- `network-config.md`
  - Content updated
- `permission-modes.md`
  - New section: "Common setups"
  - New section: "Critical paths"
- `permissions.md`
  - Content updated
- `plugin-dependencies.md`
  - Content updated
...
- `third-party-integrations.md`
  - Content updated
- `tools-reference.md`
  - New section: "EndConversation tool behavior"
- `troubleshoot-install.md`
  - Content updated
- `troubleshooting.md`
  - Content updated
...
### Added
- `corporate-launcher.md` - Run Claude Code behind a corporate launcher
...
- `model-config.md`
  - Content updated
- `network-config.md`
  - New section: "Apply network settings to background agents"
- `permission-modes.md`
  - Content updated
- `permissions.md`
  - Content updated
