...
Learn more: [Use extended thinking](common-workflows.md#use-extended-thinking-thinking-mode)
...
Learn more: [Run parallel sessions with git worktrees](common-workflows.md#run-parallel-claude-code-sessions-with-git-worktrees)
