...
| `--dangerously-skip-permissions`                                   | Whether each tool call runs                 | Nothing. [Protected path](permission-modes.md#protected-paths) checks are also skipped; only removing `/` or your home directory still prompts |
