...
<Steps>
  ...
  <Step title="Install a plugin">
    Select a plugin to view its details. {/* min-version: 2.1.143 */}On Claude Code v2.1.143 and later, the details pane includes a **Context cost** estimate so you can see how many tokens the plugin will add to your [context window](features-overview.md#understand-context-costs) every turn before you install it.
