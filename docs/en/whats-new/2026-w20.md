...
<div className="digest-meta">
  <span>Releases <a href="changelog.md#2-1-139">v2.1.139 → v2.1.142</a></span>
...
<div className="digest-feature">
  ...
  <a className="digest-feature-link" href="agent-view.md">Agent view</a>
</div>
...
<div className="digest-feature">
  ...
  <a className="digest-feature-link" href="goal.md">Goals</a>
</div>
...
<div className="digest-feature">
  ...
  <a className="digest-feature-link" href="fast-mode.md#use-fast-mode-on-opus-4-7">Fast mode on Opus 4.7</a>
</div>
...
[Full changelog for v2.1.139–v2.1.142 →](changelog.md#2-1-139)
