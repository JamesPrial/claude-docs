...
<div className="digest-meta">
  <span>Releases <a href="changelog.md#2-1-128">v2.1.128 → v2.1.136</a></span>
...
<div className="digest-feature">
  ...
  <a className="digest-feature-link" href="plugins.md">Plugins guide</a>
</div>
...
<div className="digest-feature">
  ...
  <a className="digest-feature-link" href="interactive-mode.md#command-history">Interactive mode: command history</a>
</div>
