...
<div className="digest-meta">
  <span>Releases <a href="changelog.md#2-1-143">v2.1.143 → v2.1.149</a></span>
...
<div className="digest-feature">
  ...
  <a className="digest-feature-link" href="permission-modes.md#eliminate-prompts-with-auto-mode">Auto mode</a>
</div>
...
<div className="digest-wins">
  ...
  <div className="digest-wins-grid">
    <div><a href="costs.md#track-your-costs"><code>/usage</code></a> now shows a per-category breakdown of what's driving your plan limits, attributing recent usage to skills, subagents, plugins, and individual MCP servers</div>
    ...
    <div>New <a href="code-review.md"><code>/code-review</code></a> command reports correctness bugs at a chosen effort level such as <code>/code-review high</code>, and <code>--comment</code> posts findings as inline GitHub PR comments. <code>/simplify</code> remains as a separate cleanup-only review.</div>
