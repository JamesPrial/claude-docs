...
<div className="digest-meta">
  <span>Releases <a href="changelog.md#2-1-83">v2.1.83 → v2.1.85</a></span>
...
<div className="digest-feature">
  ...
  <a className="digest-feature-link" href="permission-modes.md">Permission modes guide</a>
</div>
...
<div className="digest-feature">
  ...
  <a className="digest-feature-link" href="desktop.md#let-claude-use-your-computer">Computer use guide</a>
</div>
...
<div className="digest-feature">
  ...
  <a className="digest-feature-link" href="fullscreen.md#search-and-review-the-conversation">Fullscreen guide</a>
</div>
...
<div className="digest-feature">
  ...
  <a className="digest-feature-link" href="tools-reference.md#powershell-tool">PowerShell tool docs</a>
</div>
...
<div className="digest-feature">
  ...
  <a className="digest-feature-link" href="hooks.md">Hooks reference</a>
</div>
