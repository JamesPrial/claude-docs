...
<div className="digest-feature">
  ...
  <a className="digest-feature-link" href="model-config.md#available-models">Model configuration</a>
</div>
...
<div className="digest-feature">
  ...
  <a className="digest-feature-link" href="workflows.md">Dynamic workflows</a>
</div>
...
<div className="digest-feature">
  ...
  <a className="digest-feature-link" href="security-guidance.md">Security guidance plugin</a>
</div>
...
<div className="digest-feature">
  ...
  <a className="digest-feature-link" href="fast-mode.md#understand-the-cost-tradeoff">Fast mode pricing</a>
</div>
