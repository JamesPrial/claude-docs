...
<div className="digest-meta">
  <span>Releases <a href="changelog.md#2-1-86">v2.1.86 → v2.1.91</a></span>
...
<div className="digest-feature">
  ...
  <a className="digest-feature-link" href="computer-use.md">Computer use guide</a>
</div>
...
<div className="digest-feature">
  ...
  <a className="digest-feature-link" href="fullscreen.md">Fullscreen rendering</a>
</div>
...
<div className="digest-feature">
  ...
  <a className="digest-feature-link" href="mcp.md#raise-the-limit-for-a-specific-tool">MCP reference</a>
</div>
...
<div className="digest-feature">
  ...
  <a className="digest-feature-link" href="plugins-reference.md#file-locations-reference">Plugins reference</a>
</div>
