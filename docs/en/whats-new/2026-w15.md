...
<div className="digest-meta">
  <span>Releases <a href="changelog.md#2-1-92">v2.1.92 → v2.1.101</a></span>
...
<div className="digest-feature">
  ...
  <a className="digest-feature-link" href="ultraplan.md">Ultraplan guide</a>
</div>
...
<div className="digest-feature">
  ...
  <a className="digest-feature-link" href="tools-reference.md#monitor-tool">Monitor tool reference</a>
</div>
...
<div className="digest-feature">
  ...
  <a className="digest-feature-link" href="claude-code-on-the-web.md#auto-fix-pull-requests">Auto-fix pull requests</a>
</div>
...
<div className="digest-feature">
  ...
  <a className="digest-feature-link" href="commands.md">Commands reference</a>
</div>
...
<div className="digest-wins">
  ...
  <div className="digest-wins-grid">
    ...
    <div>Guided <a href="amazon-bedrock.md">Bedrock</a> and <a href="google-vertex-ai.md">Vertex AI</a> setup wizards on the login screen: pick "3rd-party platform" for step-by-step auth, region, credential check, and model pinning</div>
...
[Full changelog for v2.1.92–v2.1.101 →](changelog.md#2-1-92)
