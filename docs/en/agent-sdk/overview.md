...
<Note>
  Opus 4.7 (`claude-opus-4-7`) requires Agent SDK v0.2.111 or later. If you see a `thinking.type.enabled` API error, see [Troubleshooting](agent-sdk/quickstart.md#troubleshooting).
</Note>
...
<Tabs>
  <Tab title="Built-in tools">
    ...
    | **[AskUserQuestion](agent-sdk/user-input.md#handle-clarifying-questions)** | Ask the user clarifying questions with multiple choice options      |
