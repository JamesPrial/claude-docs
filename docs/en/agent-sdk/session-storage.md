...
* [`query()`](agent-sdk/typescript.md#query)
* [`startup()`](agent-sdk/typescript.md#startup)
* [`listSessions()`](agent-sdk/typescript.md#listsessions)
* [`getSessionInfo()`](agent-sdk/typescript.md#getsessioninfo)
* [`getSessionMessages()`](agent-sdk/typescript.md#getsessionmessages)
* [`renameSession()`](agent-sdk/typescript.md#renamesession)
* [`tagSession()`](agent-sdk/typescript.md#tagsession)
...
* [TypeScript `Options`](agent-sdk/typescript.md#options): Full option reference
