...
| `"auto"` (TypeScript only) | Uses a model classifier to approve or deny each tool call. See [Auto mode](permission-modes.md#eliminate-prompts-with-auto-mode) for availability and behavior                                                                                                                                                                                                                                               |
