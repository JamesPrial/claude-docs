...
| `"dontAsk"`           | Never prompts. Tools pre-approved by [permission rules](settings.md#permission-settings) run, everything else is denied                                                                                                                                                                                                                                                                                      |
