...
| `bypassPermissions`      | Runs every tool without prompting, unless an explicit [`ask` rule](agent-sdk/permissions.md#how-permissions-are-evaluated) matches | Sandboxed CI, fully trusted environments |
