...
* **Programmatically**: use the `agents` parameter in your `query()` options ([TypeScript](agent-sdk/typescript.md#agent-definition), [Python](agent-sdk/python.md#agent-definition))
...
In the Python SDK, these field names use camelCase to match the wire format. See the [`AgentDefinition` reference](agent-sdk/python.md#agent-definition) for details.
