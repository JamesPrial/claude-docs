...
<Note>
  Channels are in [research preview](channels.md#research-preview) and require Claude Code v2.1.80 or later. Team and Enterprise organizations must [explicitly enable them](channels.md#enterprise-controls).
</Note>
