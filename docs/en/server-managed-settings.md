...
<Steps>
  ...
  <Step title="Define your settings">
    Add your configuration as JSON. All [settings available in `settings.json`](settings.md#available-settings) are supported, including [managed-only settings](permissions.md#managed-only-settings) like `disableBypassPermissionsMode`.
