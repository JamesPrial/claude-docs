...
| `/doctor`        | Configuration diagnostics: invalid keys, schema errors, installation health. {/* min-version: 2.1.196 */}As of v2.1.196, also reports duplicate [subagent](sub-agents.md) names defined in the same scope and marks which one is active |
