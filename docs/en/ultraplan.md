...
Ultraplan requires a [Claude Code on the web](claude-code-on-the-web.md#who-can-use-claude-code-on-the-web) account and a GitHub repository. The cloud session runs in your account's default [cloud environment](claude-code-on-the-web.md#cloud-environment).
