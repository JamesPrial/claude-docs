...
| `EnterWorktree`        | Creates an isolated [git worktree](worktrees.md) and switches into it. Pass a `path` to switch into an existing worktree of the current repository instead of creating a new one. Not available to subagents that already run in their own working directory, such as with [`isolation: worktree`](sub-agents.md#supported-frontmatter-fields)                                                                                                                                                                                                                             | No                  |
