...
Claude Code has access to a set of tools that help it understand and modify your codebase. The tool names below are the exact strings you use in [permission rules](permissions.md#tool-specific-permission-rules), [subagent tool lists](sub-agents.md), and [hook matchers](hooks.md).
