...
Read more about [configuring permissions](settings.md) and [enabling sandboxing](sandboxing.md#sandboxing).
...
<CardGroup cols={2}>
  ...
  <Card title="Common workflows" icon="list-check" href="common-workflows.md">
