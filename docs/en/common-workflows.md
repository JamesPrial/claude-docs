...
You can also press `Shift+Tab` mid-session to cycle to plan mode. The cycle runs `default` → `acceptEdits` → `plan`. See [Plan mode](permission-modes.md#analyze-before-you-edit-with-plan-mode) for the approval flow and editing the plan in your text editor.
...
<CardGroup cols={2}>
  ...
  <Card title="Manage sessions" icon="rotate-left" href="sessions.md">
    Resume, name, and branch conversations
  </Card>

  <Card title="Worktrees" icon="code-branch" href="worktrees.md">
