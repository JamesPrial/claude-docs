...
Then set `USE_BUILTIN_RIPGREP` to `0` in your [settings.json file](settings.md#environment-variables):
...
Set `DISABLE_AUTOUPDATER` to `"1"` in the `env` key of your [settings.json file](settings.md#environment-variables):
