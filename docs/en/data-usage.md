...
| **WebFetch domain safety check**     | Default on.<br />`skipWebFetchPreflight: true` in [settings](settings.md) to disable. | Default on.<br />`skipWebFetchPreflight: true` in [settings](settings.md) to disable. | Default on.<br />`skipWebFetchPreflight: true` in [settings](settings.md) to disable. | Default on.<br />`skipWebFetchPreflight: true` in [settings](settings.md) to disable. |
