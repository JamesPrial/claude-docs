...
To make a subagent always run in its own worktree regardless of how it was started, set [`isolation: worktree`](sub-agents.md#supported-frontmatter-fields) in its frontmatter.
