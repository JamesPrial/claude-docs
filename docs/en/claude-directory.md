...
Files older than [`cleanupPeriodDays`](settings.md#available-settings) (default 30) are deleted on the next startup.
...
| `plans/`                                     | Plan files written during [plan mode](permission-modes.md#plan-mode)                        |
