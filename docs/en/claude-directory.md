...
| Cleanup logic never runs at session end                          | No `SessionEnd` hook configured                                                        | `SessionStart` and `SessionEnd` both exist. See the [hook events list](hooks.md#hook-events).                                                                                                            |
