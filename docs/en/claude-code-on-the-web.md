...
Custom environment images and snapshots are not yet supported. As a workaround, you can use [SessionStart hooks](hooks.md#sessionstart) to install packages when a session starts. This approach has [known limitations](#dependency-management-limitations).
