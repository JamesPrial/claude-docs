...
The `dontAsk` permission mode is available only in the [CLI](permissions.md#permission-modes).
...
Local sessions inherit environment variables from your shell. If you need additional variables, set them in your shell profile, such as `~/.zshrc` or `~/.bashrc`, and restart the desktop app. See [environment variables](settings.md#environment-variables) for the full list of supported variables.
...
| Key                            | Description                                                                                                                               |
| ------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------- |
| `disableBypassPermissionsMode` | set to `"disable"` to prevent users from enabling Bypass permissions mode. See [managed settings](permissions.md#managed-only-settings). |
