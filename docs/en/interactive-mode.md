...
| Shortcut     | Description            | Notes                                                                                                                                                      |
| :----------- | :--------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Hold `Space` | Push-to-talk dictation | Requires [voice dictation](voice-dictation.md) to be enabled. Transcript inserts at cursor. [Rebindable](voice-dictation.md#rebind-the-push-to-talk-key) |

## Built-in commands

Type `/` in Claude Code to see all available commands, or type `/` followed by any letters to filter. The `/` menu shows both built-in commands and [bundled skills](skills.md#bundled-skills) like `/simplify`. Not all commands are visible to every user since some depend on your platform or plan.
