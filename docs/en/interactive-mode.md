...
| `Ctrl+X Ctrl+K`                                           | Kill all running [background subagents](sub-agents.md#run-subagents-in-foreground-or-background) in this session. Press twice within 3 seconds to confirm | Subagent control                                                                                                                                                                                                                                                                                       |
