...
Claude Code also ships with [bundled skills](skills.md#bundled-skills) like `/simplify`, `/batch`, and `/debug` that appear alongside built-in commands when you type `/`. To create your own commands, see [skills](skills.md).
...
| `/model [model]`          | Select or change the AI model. For models that support it, use left/right arrows to [adjust effort level](model-config.md#adjust-effort-level). The change takes effect immediately without waiting for the current response to finish                                                                                                                            |
| `/output-style [style]`   | Switch between [output styles](output-styles.md). **Default** is standard behavior, **Explanatory** adds educational insights about implementation choices and codebase patterns, and **Learning** pauses to ask you to write small code pieces for hands-on practice. You can also [create custom output styles](output-styles.md#create-a-custom-output-style) |
| `/passes`                 | Share a free week of Claude Code with friends. Only visible if your account is eligible                                                                                                                                                                                                                                                                            |
| `/permissions`            | View or update [permissions](permissions.md#manage-permissions). Alias: `/allowed-tools`                                                                                                                                                                                                                                                                          |
...
| `/remote-env`             | Configure the default remote environment for [teleport sessions](claude-code-on-the-web.md#teleport-a-web-session-to-your-terminal)                                                                                                                                                                                                                               |
